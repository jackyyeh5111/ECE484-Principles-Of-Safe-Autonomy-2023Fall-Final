...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if msg.get_type() == 'LOCAL_POSITION_NED_COV':
            ...
            theta = 3.1415926535/2 - 1.026    # body frame rotate w.r.t global frame
            x_p   = -0.2504    # body origin move w.r.t. global frame along x 
            y_p   = -0.9017    # body origin move w.r.t. global frame along y
